export default function Badge({ type, text, icon: Icon, pill = false }: {
    type: string;
    text: string;
  ...
  const styles = {
    ...
    group: 'bg-violet-100 text-violet-700 border-violet-200 dark:bg-violet-500/10 dark:text-violet-400 dark:border-violet-500/20',
