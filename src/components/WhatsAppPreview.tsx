...
export default function WhatsAppPreview({ message, senderName = 'Synq', linkUrl, linkLabel }: WhatsAppPreviewProps) {
  ...
  return (<div className="rounded-xl overflow-hidden border border-slate-200 dark:border-slate-700">
    ...
    <div className="p-4 min-h-30 max-h-62.5 overflow-y-auto" style={{
      ...
      {message ? (<div className="flex justify-end">
        <div className="bg-[#DCF8C6] dark:bg-[#005C4B] rounded-lg rounded-tr-sm max-w-[85%] shadow-sm overflow-hidden">
          ...
          {linkUrl && (<div className="border-t border-[#c8e6b0] dark:border-[#00483d] px-3 py-2.5 flex items-center justify-center gap-2 cursor-pointer hover:bg-[#d4f0c5] dark:hover:bg-[#004a3e] transition-colors">
      ...
      </div>) : (<div className="flex items-center justify-center h-20">
