...
export default function TrialBanner() {
  ...
  return (<div className={`bg-linear-to-r ${bgClass} text-white rounded-xl p-3 mb-4 flex items-center justify-between gap-3`}>
    ...
    <div className="flex items-center gap-2 shrink-0">
      <button onClick={() => router.push('/plans')} className="bg-white/20 hover:bg-white/30 text-white text-xs font-semibold px-3 py-1.5 rounded-lg transition-colors">
          Escolher Plano
      </button>
      <button onClick={() => {
        setDismissed(true);
