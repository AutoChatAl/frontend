...
export default function AISchedulingSection({ schedulingQueryEnabled, schedulingBookingEnabled, onToggleQuery, onToggleBooking }: AISchedulingSectionProps) {
        ...
        <div className="flex items-start gap-4 p-4 bg-slate-50 dark:bg-slate-700/30 rounded-xl border border-slate-100 dark:border-slate-700">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center justify-between gap-3">
              ...
              <button onClick={() => onToggleQuery(!schedulingQueryEnabled)} className={`relative w-11 h-6 rounded-full transition-colors shrink-0 ${schedulingQueryEnabled ? 'bg-indigo-600' : 'bg-slate-300 dark:bg-slate-600'}`}>
            ...
            {schedulingQueryEnabled && (<div className="mt-3 px-3 py-2 bg-blue-50 dark:bg-blue-900/10 rounded-lg border border-blue-100 dark:border-blue-900/20">
        ...
        <div className="flex items-start gap-4 p-4 bg-slate-50 dark:bg-slate-700/30 rounded-xl border border-slate-100 dark:border-slate-700">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center justify-between gap-3">
              ...
              <button onClick={() => onToggleBooking(!schedulingBookingEnabled)} className={`relative w-11 h-6 rounded-full transition-colors shrink-0 ${schedulingBookingEnabled ? 'bg-indigo-600' : 'bg-slate-300 dark:bg-slate-600'}`}>
            ...
            {schedulingBookingEnabled && (<div className="mt-3 px-3 py-2 bg-green-50 dark:bg-green-900/10 rounded-lg border border-green-100 dark:border-green-900/20">
            ...
            {schedulingBookingEnabled && !schedulingQueryEnabled && (<div className="mt-2 px-3 py-2 bg-amber-50 dark:bg-amber-900/10 rounded-lg border border-amber-100 dark:border-amber-900/20">
