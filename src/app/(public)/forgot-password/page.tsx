...
export default function ForgotPasswordPage() {
  ...
  return (<AuthShell title="Recuperar senha" subtitle="Informe seu email para receber o link de recuperação.">
    {sent ? (<div className="space-y-6">
      ...
      <Link href="/login" className="block w-full text-center bg-indigo-600 text-white py-2.5 rounded-lg font-bold text-sm hover:bg-indigo-700 transition-all">
            Voltar para Login
      </Link>
    </div>) : (<form className="space-y-5" onSubmit={handleSubmit}>
